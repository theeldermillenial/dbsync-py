...
class TestSchemaCompliance:
    ...
    def test_no_schema_validation_errors_for_blockchain_models(self):
        ...
        try:
            ...
            blockchain_tables = [
                "address", "stake_address", "block", "tx", "epoch", 
                "slot_leader", "schema_version", "multi_asset", 
            ...
            for result in results:
                ...
                if hasattr(result, 'is_valid') and hasattr(result, 'table_name'):
                    if (not result.is_valid and result.errors and 
                        result.table_name in blockchain_tables):
    ...
    def test_transaction_model_has_treasury_donation(self):
        ...
        assert hasattr(tx, "treasury_donation"), "Transaction model missing treasury_donation field"
    ...
    def test_schema_version_uses_bigint(self):
        ...
        for field_name in stage_fields:
            ...
            assert isinstance(column.type, BigInteger), f"Field {field_name} should use BigInteger, not {type(column.type)}"
    ...
    def test_comprehensive_schema_validation(self):
        ...
        try:
            ...
            compliance_rate = (valid_tables / total_tables) * 100 if total_tables > 0 else 0
...
class TestModelFieldMappings:
    ...
    def test_transaction_model_complete_fields(self):
        ...
        required_fields = [
            "id_", "hash_", "block_id", "block_index", 
            "out_sum", "fee", "deposit", "size",
            "invalid_before", "invalid_hereafter", 
            "valid_contract", "script_size", "treasury_donation"
        ]
